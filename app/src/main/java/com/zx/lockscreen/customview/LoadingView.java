...
public class LoadingView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText( "75", 0 + 10, y + 5, textPaint);
        canvas.drawText( "50", x, mHeight, textPaint);
        canvas.drawText( "25", mWidth - 25, y + 5, textPaint);
        canvas.drawText( "0", x, 25, textPaint);
        //绘制上层菊花,也就是进度
        canvas.rotate(360 / lines, x, y);
        for (; count > 0; count--) {
            bfPaint.setColor(beforePaintColor + count * 5);
